...
- **macOS (Apple Silicon)** —
  [`qa40x-rs Audio Analyzer_0.3.0_aarch64.dmg`](https://github.com/GarageDeveloper/qa40x-rs/releases/download/v0.3.0/qa40x-rs.Audio.Analyzer_0.3.0_aarch64.dmg):
...
- **macOS (Intel, legacy)** —
  [`qa40x-rs Audio Analyzer_0.3.0_x86_64-legacy.dmg`](https://github.com/GarageDeveloper/qa40x-rs/releases/download/v0.3.0/qa40x-rs.Audio.Analyzer_0.3.0_x86_64-legacy.dmg):
