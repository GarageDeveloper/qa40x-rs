...
- **I2S output** — drive the front-panel I2S expansion port (48 kHz,
  ...
  per-device toggle and digital reference level. Deliberately richer than
  the official app, which mirrors Generator 1/2 at a fixed 0 dBV = 0 dBFS;
  at the default reference the level mapping is identical (see
  `doc/device-notes.md` §10).
...
- **macOS (Apple Silicon)** —
  [`qa40x-rs Audio Analyzer_0.4.0_aarch64.dmg`](https://github.com/GarageDeveloper/qa40x-rs/releases/download/v0.4.0/qa40x-rs.Audio.Analyzer_0.4.0_aarch64.dmg):
...
- **macOS (Intel, legacy)** —
  [`qa40x-rs Audio Analyzer_0.4.0_x86_64-legacy.dmg`](https://github.com/GarageDeveloper/qa40x-rs/releases/download/v0.4.0/qa40x-rs.Audio.Analyzer_0.4.0_x86_64-legacy.dmg):
