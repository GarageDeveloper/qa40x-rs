...
> currently agree within 0.001 dB / 0.001 dB / 0.01 dB / 0.6 dB / 1.7 dB;
...
- **macOS (Apple Silicon)** —
  [`qa40x-rs Audio Analyzer_0.2.2_aarch64.dmg`](https://github.com/GarageDeveloper/qa40x-rs/releases/download/v0.2.2/qa40x-rs.Audio.Analyzer_0.2.2_aarch64.dmg):
...
- **macOS (Intel, legacy)** —
  [`qa40x-rs Audio Analyzer_0.2.2_x86_64-legacy.dmg`](https://github.com/GarageDeveloper/qa40x-rs/releases/download/v0.2.2/qa40x-rs.Audio.Analyzer_0.2.2_x86_64-legacy.dmg):
